...
def _main() -> None:
    ...
    if hf_token is None:
        message = "Could not get huggingface token."
    ...
    _logger.info("copy config.yaml to %s", dst_config_path)
    ...
    _logger.info("copy pytorch_model.bin to %s", dst_segmentation_model_path)
